...
namespace Testing
{
    public partial class Form2 : Form
    {
        ...
        string[] path= { @"C:\Users\user\Desktop\Testing-System-main\bin\Debug\savollar.txt",
            @"C:\Users\user\Desktop\Testing-System-main\bin\Debug\variantlar.txt",
            @"C:\Users\user\Desktop\Testing-System-main\bin\Debug\javoblar.txt"
            ...
            for (int j = 0; j < savollar.Length; j++)
            {
               ...
               // questionGroup.Text = savollar[j];
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    radioButton.Location = new Point(x, questionLabel.Bottom + radioButtonOffset * i);
